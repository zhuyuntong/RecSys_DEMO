...
from MF import decompose_matrix_factorization_als, predict_aff)score_als


class FeatureProcessor:
    def __init__(self, user_df, business_df, review_df):
    ...
    def process_all_features(self, sc, train_df, data_folder_path, file_path):
        ...
        ) = matrix_factorization_als(sc, data_folder_path, file_path)
