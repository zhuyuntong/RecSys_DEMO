...
def decompose_matrix_factorization_als(sc, data_folder_path, rank=51, reg_param=30, alpha=1530.0):  # FIXME:
    ...
    return (user_features_bcast, biz_features_bcast, user_ids, business_ids, user_features_rdd, biz_features_rdd)


def predict_score_als(
    sc, user_features_bcast, biz_features_bcast, user_ids, business_ids, pair_file_path='../yelp_combined.csv'
):
    ##################################################################
    pair_rdd = (
    ...
    final_user_features_rdd, final_biz_features_rdd, len_vectors = process_vector_features(
        sc,
        valid_pairs_rdd,
        user_features_rdd,
        biz_features_rdd,
...
def process_vector_features(
    ...
    return final_user_features_rdd, final_biz_features_rdd, len(default_vector_bcast.value)
