...
def main(args):
    ...
    feature_processor.user_features_bcast.unpersist()
    feature_processor.biz_features_bcast.unpersist()
    feature_processor.user_ids_bcast.unpersist()
    feature_processor.business_ids_bcast.unpersist()
