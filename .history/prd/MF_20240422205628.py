...
def decompose_matrix_factorization_als(
    sc, data_folder_path, rank=51, reg_param=30, alpha=1530.0  # FIXME:
):
    # Helper function to parse JSON data
    def parse_json(line):
        try:
...
def predict_score_als(sc, , user_features_bcast, biz_features_bcast, user_ids, business_ids, pair_file_path='../yelp_combined.csv'):
    ##################################################################
    pair_rdd = (
